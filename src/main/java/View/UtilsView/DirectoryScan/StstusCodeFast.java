...
public class StstusCodeFast extends Application {

    final String a = "<h1>信息响应(100)</h1>\n" +
            "\n" +
            "<h2>100 Continue</h2>\n" +
            "\n" +
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.getIcons().add(new Image(StstusCodeFast.class.getResourceAsStream("/img/icon/book-2-line.png")));
        VBox root = new VBox();
